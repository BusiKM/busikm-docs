...
export function KartaZysku() {
  return (
    <div className="flex flex-col gap-2 rounded-card border border-line-dark bg-surface p-4 text-[12px] shadow-[0_40px_100px_rgba(11,95,255,.18),0_30px_60px_rgba(0,0,0,.6)] lg:aspect-4/3 lg:gap-3.5 lg:p-7 lg:text-[13px]">
      ...
      {costs.map((c, i) => (
        <div
          key={c.label}
          className={`flex justify-between text-ink-muted lg:py-2 ${
      ...
      <div className="mt-auto flex items-end justify-between gap-4">
        <div>
          ...
          <div className="text-[18px] font-bold tracking-[-0.02em] text-green lg:text-[30px]">
            2 930 €<span className="hidden lg:inline"> · 12 540 zł</span>
          </div>
        </div>
